...
let me ={
  firstName: 'Alex',
  superHeroName: 'White Stallion',
  homeTown: 'Aloha, OR',
  superPowers: ['Genius', 'Billionaire', 'Playboy'],
...
// Outside of the for loop but still inside of setColor, invoke the function called background which will take in three arguments. These arguments should be each item of your array. This is a function we created for you to set the background colors.
...
// Loop over the arr param and 

// run a function called createLi(), which will take each item of the array as an agument. The createLi function is a function we created to set the data on the screen. It outside the scope of this project
...
// Let's imagine our super hero needs to go undercover and we need to remove all info about them. That is what this function will do. Loop over the object and change each keys value to 'redacted'. 
